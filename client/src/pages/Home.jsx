...
function Home() {
  ...
  return (
    <div className="overflow-hidden bg-gray-50">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-tr from-pink-50 via-rose-50/30 to-amber-50/50 py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-pink-100/60 backdrop-blur-md rounded-full text-pink-700 text-xs font-semibold tracking-wider uppercase border border-pink-200/40">
              <Sparkles size={12} className="animate-spin" />
              <span>100% Handcrafted Luxury Art</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-extrabold tracking-tight text-gray-900 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
              ...
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white text-gray-700 font-semibold px-8 py-4 rounded-2xl border border-gray-200 hover:border-pink-300 hover:text-pink-600 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
              >
            ...
            {/* Micro Stats */}
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-200/60 max-w-md mx-auto lg:mx-0">
              <div>
                <p className="text-2xl sm:text-3xl font-extrabold text-pink-600">500+</p>
                <p className="text-xs text-gray-500 font-medium">Custom Pieces Poured</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium">Unique Craftsmanship</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="relative w-full max-w-[420px] aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white transform hover:scale-[1.02] transition-all duration-500">
              <img 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent flex items-end p-8">
                <div className="bg-white/80 backdrop-blur-md p-4 rounded-2xl w-full border border-white/50 shadow-sm flex items-center justify-between">
                  <div>
                    <p className="text-xs text-gray-400 font-bold uppercase tracking-wide">Featured Artwork</p>
                    <p className="text-sm font-bold text-gray-900">Whispering Winds Abstract</p>
                  </div>
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:block w-36 h-36 rounded-2xl overflow-hidden border-4 border-white shadow-xl rotate-6 transform hover:rotate-0 hover:scale-110 transition-all duration-300">
              <img 
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-extrabold text-gray-900 mt-2">Explore Our Collections</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {categories.map((cat, idx) => (
            <Link 
              key={idx}
              to={cat.link}
              className="group relative h-[360px] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-end p-5 bg-gray-900 border border-gray-100"
            >
              {/* Image backdrop */}
              <img 
                src={cat.bgImage} 
              ...
              {/* Floating Icon */}
              <div className="relative z-10 p-3 bg-white/90 backdrop-blur-md rounded-xl w-fit mb-4 group-hover:scale-110 transition-transform duration-300 border border-white/50">
                {cat.icon}
              </div>
      ...
      <section className="py-20 bg-white border-y border-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
            <div>
              <span className="text-xs font-bold text-pink-600 uppercase tracking-widest">New Pours</span>
              <h2 className="text-3xl font-serif font-extrabold text-gray-900 mt-2">Featured Artworks</h2>
            ...
            <Link 
              to="/products" 
              className="group flex items-center gap-2 text-pink-600 font-semibold text-sm hover:text-pink-700 transition-colors shrink-0"
            >
              View Full Gallery
          ...
          {loading ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[1, 2, 3, 4].map((id) => (
                <div key={id} className="animate-pulse space-y-4">
                  <div className="bg-gray-100 rounded-2xl aspect-[4/5]" />
            ...
            <div className="text-center py-16 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
              <p className="text-gray-500 font-medium">Art collections are currently loading or database is empty.</p>
            </div>
          ) : (
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-extrabold text-gray-900 mt-2">Beautifully Crafting Moments</h2>
          <p className="text-gray-500 text-sm mt-3">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow text-center">
            <div className="mx-auto w-12 h-12 bg-pink-50 rounded-xl flex items-center justify-center text-pink-600 mb-5">
              <Sparkles size={24} />
            </div>
            <h3 className="font-bold text-gray-900 text-base mb-2">Premium Materials</h3>
          ...
          <div className="p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow text-center">
            <div className="mx-auto w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center text-amber-600 mb-5">
              <Gift size={24} />
            </div>
            <h3 className="font-bold text-gray-900 text-base mb-2">Custom Handcrafting</h3>
            <p className="text-xs text-gray-500 leading-relaxed font-normal">
          ...
          <div className="p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow text-center">
            <div className="mx-auto w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 mb-5">
              <ShieldCheck size={24} />
            </div>
            <h3 className="font-bold text-gray-900 text-base mb-2">Perfect Preservation</h3>
            <p className="text-xs text-gray-500 leading-relaxed font-normal">
          ...
          <div className="p-6 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow text-center">
            <div className="mx-auto w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center text-purple-600 mb-5">
              <Truck size={24} />
            </div>
            <h3 className="font-bold text-gray-900 text-base mb-2">Secure Nationwide Shipping</h3>
            <p className="text-xs text-gray-500 leading-relaxed font-normal">
      ...
      <section id="preservation-section" className="py-24 bg-gradient-to-tr from-pink-50/50 via-white to-amber-50/40 border-t border-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
          
          {/* Form Description */}
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-pink-100/60 rounded-full text-pink-700 text-xs font-semibold uppercase tracking-wider">
              <Flower size={12} />
            ...
            <ul className="space-y-3 pt-3">
              {[
                ...
                <li key={index} className="flex gap-3 items-center text-xs font-semibold text-gray-700">
                  <span className="w-5 h-5 bg-pink-100 rounded-full flex items-center justify-center text-pink-600 text-[10px]">✓</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
              ...
              <form onSubmit={handleInquirySubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-gray-400 uppercase">Your Name</label>
                    <input 
                      type="text" 
                      name="name"
                      required
                      ...
                      className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-xs text-gray-800 focus:outline-none focus:border-pink-500 focus:bg-white transition-all"
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-gray-400 uppercase">Preservation Type</label>
                    <select 
                      name="eventType"
                ...
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-gray-400 uppercase">Event / Delivery Date</label>
                  <input 
                    type="date" 
                    name="eventDate"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-gray-400 uppercase">Request Details / Floral Layout Ideas</label>
                  <textarea 
                    name="details"
                    rows="3"
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-extrabold text-gray-900 mt-2">What Art Lovers Say</h2>
          <p className="text-gray-500 text-sm mt-3">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((test, index) => (
            <div key={index} className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm relative flex flex-col justify-between">
              <div>
                {/* Stars */}
              ...
              <div className="mt-6 pt-6 border-t border-gray-50 flex items-center gap-3">
                <div className="w-10 h-10 bg-pink-100 text-pink-600 rounded-full flex items-center justify-center font-bold text-sm">
                  {test.name.charAt(0)}
                </div>
                <div>
                  <h4 className="font-bold text-sm text-gray-900">{test.name}</h4>
                  <p className="text-[11px] text-pink-600 font-medium">{test.role}</p>
                </div>
              </div>
            </div>
          ))}
